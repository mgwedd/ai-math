...
registerScene({
  ...
  goals: [
    goal('Find the STRETCH eigen-direction: drag v so Mv points the same way, ×3 as long, to see how an eigenvector is a direction a matrix only stretches, never rotates',
...
registerScene({
  ...
  goals: [
    ...
    goal('Send v2 to the OTHER eigen-direction (ratio ≈ 1), to see how a symmetric matrix’s second eigen-direction sits perpendicular to the first',
