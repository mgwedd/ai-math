...
<div class="formula">H(p, q) = &minus;&#x03A3; p<sub>i</sub> log q<sub>i</sub>&nbsp;&nbsp;&nbsp;(bits: use log&#x2082;; nats: use ln)</div>
...
<div class="formula">I(X; Y) = &Sigma;<sub>x,y</sub> p(x,y) &thinsp;log &thinsp; p(x,y) / [p(x) p(y)]</div>
...
<div class="formula">I(X; Y) = H(X) &minus; H(X|Y) = H(Y) &minus; H(Y|X) = H(X) + H(Y) &minus; H(X, Y)</div>
