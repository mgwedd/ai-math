...
registerScene({
  ...
  goals: [
    goal('B is fixed. Drag A so C = B∘A sends î to ★₁ (apply A, then B), to see how composing two matrices means applying the right one first, then the left',
...
registerScene({
  ...
  goals: [
    ...
    goal('Place B (both columns) to match its target — applied SECOND (±0.2) and hold, to see how swapping which matrix goes second would land the composition somewhere else entirely',
