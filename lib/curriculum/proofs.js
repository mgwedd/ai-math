...
INTERACTIVES.pfHuntPrime = (stage, api) => pickOne(stage, api, {
  ...
  cards:[
   ...
   {html:'2', no:'2 is even AND prime, so it is exactly the counterexample that refutes "every prime is odd."'},
...
INTERACTIVES.pfRepair = (stage, api) => pickOne(stage, api, {
  ...
  cards:[
   {html:'for all integers n &gt;= 2', no:'This is the right repair: it excludes exactly the failing cases n = 0 and n = 1, and n^2 &gt; n holds for every integer n &gt;= 2.'},
...
INTERACTIVES.pfHuntML = (stage, api) => pickOne(stage, api, {
  ...
  cards:[
   {html:'"More parameters than training points always means worse test error."', no:'This is the claim double descent refutes: past the interpolation threshold, test error can fall again.'},
