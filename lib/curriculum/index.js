...
registerLesson({
  ...
  interactive:'boss-la',
  // P2 wave F: additive scene arc (CONTRACT §1; lib/curriculum/scenes/la-boss.js).
  // `interactive` above is untouched — same additive pattern as every prior migration.
  scenes:[
...
registerLesson({
  ...
  scenes:[
    'deriv.secant', 'deriv.zoom', 'deriv.trace', 'deriv.flat',
    'deriv.sign', 'deriv.capstone',
  ],
  labs:[
...
// P2 wave H: founds the new `world:'rl'` track with its first lesson
// (rl-mdp), scenes-first — see rl.js and scenes/rl-mdp.js.
await import('./rl.js');
