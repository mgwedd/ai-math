  ...
  function renderScenes(){
    ...
    function showScene(){
      ...
      const b=sceneShell(
        ...
        '<div class="btn-row">'+
          '<button class="btn ghost" id="back">← '+(si===0?'Map':'Previous scene')+'</button>'+
      ...
      function onAllGoals(){
        nextBtn.disabled=false; confetti(isCapstone?120:35);
      ...
      const { g } = mountGoals(goalsHost, goalKey, sc.goals||[], onAllGoals);
