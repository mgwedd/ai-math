...
/* ================================================================
   ...
   UI + answer-checking. That contract is `ctx`:
     ctx.miss(nearEl, whyHtml)  — record a wrong attempt: logs a
        quiz_answer{correct:false} event, marks the question "tried" (so a
        later correct answer earns the after-miss rate), and renders inline
        feedback next to nearEl. Call once per wrong attempt.
