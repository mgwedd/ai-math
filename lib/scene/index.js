...
// Control seam (v1.4): slider — an accessible DOM-overlay control that writes
// through a param atom and counts as learner input. Runtime lifecycle in scene.js.
export { slider } from './seams/controls.js';
