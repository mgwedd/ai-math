...
registerLesson({
  ...
  expositions:[
    ...
    {key:'span',  title:'Combinations fill a plane — or collapse to a line', figure:'vecopsSpanFig', caption:'Every \\(c_1 a + c_2 b\\) is the <b>span</b> of a and b. Independent vectors reach the whole plane; when one is a multiple of the other, the span collapses to a single line — the first sight of <b>linear dependence</b>.'},
  ],
  labs:[
