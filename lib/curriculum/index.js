...
registerLesson({
  ...
  // Scene Kit (VISUAL_FIRST §7) migration: the seven-scene flagship arc
  // (lib/curriculum/scenes/la-dot.js), ending in the randomized dot.capstone
  // exam. ADDITIVE — the labs/INTERACTIVES.dot lab above stays; this is what
  // makes validateCurriculum's CONTRACT §7.1 capstone-last check (registry.js)
  // actually run against real content instead of only synthetic test lessons.
  scenes:[
