...
INTERACTIVES.matrixBuild = function(stage, api){
  ...
  note(L.ctrl, 'Place the columns: sliders a,c aim <b style="color:#2dd4a0">î</b>; b,d aim <b style="color:#ff5c7a">ĵ</b>. A reflection over \\(y=x\\) swaps the axes; a 45° rotation puts both columns at ±0.71.');
  draw();
};
