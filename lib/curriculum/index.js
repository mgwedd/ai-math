...
registerLesson({
  ...
  expositions:[
    {key:'columns', title:'The columns are landing spots', figure:'matColumns', caption:'A 2×2 matrix is defined by <b>where it sends the basis vectors</b>: \\(\\hat\\imath=[1,0]\\) lands on column 1, \\(\\hat\\jmath=[0,1]\\) on column 2. \\(M=\\begin{bmatrix}a&b\\\\c&d\\end{bmatrix}\\) — read the columns and you know the whole warp.'},
    {key:'linearity', title:'Every vector rides along', figure:'matLinearity', caption:'Once the basis is placed, all of space follows by linearity: \\(M[x,y] = x\\,(M\\hat\\imath) + y\\,(M\\hat\\jmath)\\). Watch \\(Mv\\) trace an ellipse as v circles the origin — the grid carries it.'},
    {key:'gallery', title:'Four numbers, four transformations', figure:'matGallery', caption:'Rotations, shears, scales, and reflections are all just choices of the four entries. The columns tell you which one you are looking at.'},
  ],
  labs:[
    ...
    {key:'build', title:'Build a named transform', interactive:'matrixBuild',
     intro:'<p>Set the four entries to construct transforms by <strong>placing the columns</strong>: a reflection over the x-axis, a 45° rotation, and a reflection over the line \\(y=x\\). Aim î and ĵ at the right landing spots.</p>'},
    {key:'readoff', title:'Read the matrix off the warp', interactive:'matrixReadoff',
     intro:'<p>The inverse of exploring: a target warp is shown as a ghost grid. Drag the î-landing and ĵ-landing dots until your grid matches it — you are <strong>reading the matrix off the transformation</strong>.</p>'},
  ],
  quiz:[
