...
/* --- Reinforcement-learning arc (lib/curriculum/rl.js:
       rl-mdp, rl-qlearning, rl-policy). Tags are authored as these slugs
       directly, so no TAG_ALIASES entries are needed. --- */
registerConcept({
...
registerConcept({
  id: 'temporal-difference-learning', world: 'ml', title: 'Temporal-difference learning',
  wikipedia: 'Temporal_difference_learning',
  prereqs: ['bellman-equation'],
});
registerConcept({
  id: 'q-learning', world: 'ml', title: 'Q-learning',
  wikipedia: 'Q-learning',
  prereqs: ['temporal-difference-learning'],
});
registerConcept({
  id: 'exploration-exploitation', world: 'ml', title: 'Exploration vs exploitation',
  wikipedia: 'Multi-armed_bandit',
  prereqs: ['q-learning'],
});
registerConcept({
  id: 'policy-gradient', world: 'ml', title: 'Softmax policies & policy gradients (REINFORCE)',
  wikipedia: 'Policy_gradient_method',
  prereqs: ['q-learning', 'gradient-descent'],
});
registerConcept({
  id: 'rlhf', world: 'ml', title: 'RLHF: reward models & the KL-regularized objective',
  wikipedia: 'Reinforcement_learning_from_human_feedback',
  prereqs: ['policy-gradient', 'entropy-cross-entropy'],
});
