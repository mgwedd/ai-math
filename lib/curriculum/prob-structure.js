...
registerLesson({
  ...
  <div class="formula">P(X = x) = Σ<sub>y</sub> P(X = x, Y = y)</div>
  ...
  <div class="formula">P(X = x | Y = y) = P(X = x, Y = y) / P(Y = y)</div>
...
registerLesson({
  ...
  <div class="formula">P(X, Y) = P(X) · P(Y)   for every cell</div>
  ...
  <div class="formula">P(X, Y | Z) = P(X | Z) · P(Y | Z)</div>
...
registerLesson({
  ...
  <div class="formula">Cov(X, Y) = E[(X − μ<sub>X</sub>)(Y − μ<sub>Y</sub>)]</div>
  ...
  <div class="formula">ρ = Cov(X, Y) / (σ<sub>X</sub> σ<sub>Y</sub>)</div>
