...
function renderHome(){
  let h = '<div class="hero"><h1>The <span>structure</span> beneath machine learning</h1>'+
    '<p>Work through the linear algebra, calculus, probability, and optimization that modern AI is built on — one interactive lesson at a time.</p></div>';
  h += reviewSectionHTML(); // daily spaced-repetition review (self-contained)
...
export { buildReviewQueue, interleaveByWorld }; // pure selection logic (unit-tested)
