...
/* ---------- learner progress tools (available to everyone) ----------
   ...
   and resetting their own progress. Override state lives in S.admin
   ({unlockAll, unlocked:{id:true}}) so it survives reload, but is kept OUT of
   the normal progress maps so a "reset" never touches it (and vice-versa). */
