...
registerLesson({
  ...
  <div class="formula">∂f/∂x = slope of the x-slice     ∂f/∂y = slope of the y-slice</div>
  ...
  <div class="formula">∇f = [ ∂f/∂x , ∂f/∂y ]       f(a+Δ) ≈ f(a) + ∇f(a) · Δ</div>
...
registerLesson({
  ...
  <div class="formula">J = ∂(outputs)/∂(inputs)   —   row i, col j = ∂(outputᵢ)/∂(inputⱼ)</div>
  ...
  <div class="formula">J(y w.r.t. x) = J(y w.r.t. u) · J(u w.r.t. x)</div>
...
registerLesson({
  ...
  <div class="formula">∇f = λ ∇g       (at the constrained optimum)</div>
  ...
  <div class="formula">ℒ(x, y, λ) = f(x, y) − λ · g(x, y)</div>
