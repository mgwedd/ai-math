/* ================================================================
   ...
   onto the arc's goals (every goal, not just the capstone, carries one):
     'residual is orthogonal'                    → scene 1b + capstone g3
     'scalar projection'                         → scenes 1a, 2 (BOTH goals —
                                  mirrored same-mechanic goals share a tag,
                                  the det.collapse precedent; review finding
                                  R-CONTENT wave L), 3 + capstone g1
